...
#define CANMORE_CLIENT_ID_LED_BOARD 6
#define CANMORE_CLIENT_ID_SBC_BOARD 7
#define CANMORE_CLIENT_ID_IVC_BOARD 8
...
#define CANMORE_CLIENT_ID_DOWNWARDS_CAMERA 6
