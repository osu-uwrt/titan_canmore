#ifndef CANMORE__REMOTE_TTY_INTERFACE_H_
#define CANMORE__REMOTE_TTY_INTERFACE_H_
...
#define CANMORE_REMOTE_TTY_CALC_ID(client_id, direction, subch, seq_cmd)                                               \
    CANMORE_CALC_EXT_ID(client_id, CANMORE_TYPE_UTIL, direction, CANMORE_CHAN_REMOTE_TTY,                              \
