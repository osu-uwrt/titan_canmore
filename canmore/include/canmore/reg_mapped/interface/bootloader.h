#ifndef CANMORE__REG_MAPPED__INTERFACE__BOOTLOADER_H_
#define CANMORE__REG_MAPPED__INTERFACE__BOOTLOADER_H_
 ...
 * Implemented control interface for CANMORE_CONTROL_INTERFACE_MODE_BOOTLOADER
 *
 * Page Map:
 * ==========
 *
