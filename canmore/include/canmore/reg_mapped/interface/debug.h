#ifndef CANMORE__REG_MAPPED__INTERFACE__DEBUG_H_
#define CANMORE__REG_MAPPED__INTERFACE__DEBUG_H_
 ...
 * Implemented control interface for CANMORE_CONTROL_INTERFACE_MODE_NORMAL (see canmore/protocol.h)
 *
 * Page Map:
 * ==========
 *
...
#define CANMORE_DBG_CRASH_LOG_PREV_SCRATCH_1_CLEAN_RESET_BOOTROM_VALUE 7
