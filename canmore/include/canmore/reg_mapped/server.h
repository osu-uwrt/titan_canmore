#ifndef CANMORE__REG_MAPPED__SERVER_H_
#define CANMORE__REG_MAPPED__SERVER_H_
 ...
 *      the canmore/protocol.h file to ensure that it does not overlap with other control interfaces. This
